// ======================================================================
// Atom.v generated from TopDesign.cysch
// 07/23/2015 at 09:20
...
module SCB_P4_v2_0_0 (
	...
	cy_clock_v1_0
		#(.id("02cb71e9-4258-4d11-89bc-04bb13534764/f709e1b5-0661-4ea1-9017-8746e3c53259/43ec2fa1-bf22-4b71-9477-b6ca7b97f0b0/81fcee8a-3b8b-4be1-9a5f-a5e2e619a938"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("02cb71e9-4258-4d11-89bc-04bb13534764/f709e1b5-0661-4ea1-9017-8746e3c53259/43ec2fa1-bf22-4b71-9477-b6ca7b97f0b0/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("02cb71e9-4258-4d11-89bc-04bb13534764/f709e1b5-0661-4ea1-9017-8746e3c53259/43ec2fa1-bf22-4b71-9477-b6ca7b97f0b0/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// RS485_Atom_v1_0(Address=176, IsArbiter=false, NiceNodeType=Normal, NodeDBSize=8, NodeType=1, CY_COMPONENT_NAME=RS485_Atom_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=comm:RS485, CY_INSTANCE_SHORT_NAME=RS485, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=comm_RS485, )
module RS485_Atom_v1_0_1 (
    ex_RX,
    ex_TX,
    ex_DE,
    ex_nRE,
	...
	cy_psoc3_pins_v1_10
		#(.id("02cb71e9-4258-4d11-89bc-04bb13534764/f709e1b5-0661-4ea1-9017-8746e3c53259/e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("02cb71e9-4258-4d11-89bc-04bb13534764/f709e1b5-0661-4ea1-9017-8746e3c53259/cf0745ac-3082-45d6-9bdf-cabb0ab13964"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    Count7_v1_0 Timeout (
        ...
        .cnt(Net_83[6:0]),
        .tc(Net_72));
    defparam Timeout.EnableSignal = 0;
    defparam Timeout.LoadSignal = 0;


	cy_clock_v1_0
		#(.id("02cb71e9-4258-4d11-89bc-04bb13534764/f709e1b5-0661-4ea1-9017-8746e3c53259/7b73350e-3b43-43bf-a768-47466bd85082"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000000"),
		  .is_direct(0),
...
// JSON_Comm_v1_0(Atom_ID=0, Atom_Modes=	X(Start)  	X(Test) 	X(Idle) 	X(Shutdown), Atom_Orders=, Atom_Type=87, Atom_Variables=  X(sleepPeriod, int, i)   X(shutdownTime, int, i)   X(test, char *, s)    X(innerPressure, int, i)   X(outerPressure, int, i)   X(currentFlow, int, i)     X(totalVolume, int, i)    X(valveStatus, int, i)    X(lastStartNumber, int, i)     X(lastStartVolume, int, i)     X(lastStartFlow, int, i)     X(startTime, int, i)   X(stopTime, int, i)      X(numStarts, int, i)     X(volPerStart, int, i)    X(maxVol, int, i)    X(minVol, int, i)     X(fertigationTable0, int *, ia)     X(fertigationTable1, int *, ia)      X(fertigationTable2, int *, ia)     X(fertigationTable3, int *, ia)     X(fertigationTable4, int *, ia)     X(fertigationTable5, int *, ia)     X(fertigationTable6, int *, ia)     X(fertigationTable7, int *, ia)     X(fertigationTable8, int *, ia)     X(fertigationTable9, int *, ia)   X(notBefore, int, i)   X(notAfter, int, i)   X(dilutionFactorA, int, i)   X(dilutionFactorB, int, i)   X(venturiSuctionA, int, i)   X(venturiSuctionB, int, i)   X(squareMeters, int, i)   X(lPerSqMeterPerDay, int, i)   X(cropType, int, i), AtomRSAddr=176, CY_COMPONENT_NAME=JSON_Comm_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=comm, CY_INSTANCE_SHORT_NAME=comm, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=comm, )
module JSON_Comm_v1_0_2 ;
...
module ADC_SAR_SEQ_P4_v2_10_5 (
	...
	cy_psoc3_pins_v1_10
		#(.id("d4c108ae-1e44-4d25-a37f-2cdb522219b3/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("d4c108ae-1e44-4d25-a37f-2cdb522219b3/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("9dd7e8dc-ef3e-468b-a8f7-7c14329b8ea1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 R16 (
        .connect({
            Net_40,
            Net_39
        })
    );
    defparam R16.comp_name = "Resistor_v1_0";
    defparam R16.port_names = "T1, T2";
    defparam R16.width = 2;
	...
	wire [0:0] tmpOE__Flow_IN_1_net;
	wire [0:0] tmpIO_0__Flow_IN_1_net;
	wire [0:0] tmpINTERRUPT_0__Flow_IN_1_net;
	electrical [0:0] tmpSIOVREF__Flow_IN_1_net;

	cy_psoc3_pins_v1_10
		#(.id("82ccb282-2670-4851-9a8a-81faa7c1b2de"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Flow_IN_1
		 (.oe(tmpOE__Flow_IN_1_net),
		  .y({1'b0}),
		  .fb({Net_215}),
		  .io({tmpIO_0__Flow_IN_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Flow_IN_1_net),
		  .interrupt({tmpINTERRUPT_0__Flow_IN_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Flow_IN_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("d387ac81-7962-4b15-b476-e6fab54249f0"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__ON1_DIR1_net;
	wire [0:0] tmpFB_0__ON1_DIR1_net;
	wire [0:0] tmpIO_0__ON1_DIR1_net;
	wire [0:0] tmpINTERRUPT_0__ON1_DIR1_net;
	electrical [0:0] tmpSIOVREF__ON1_DIR1_net;

	cy_psoc3_pins_v1_10
		#(.id("519fe391-b55c-4fad-b598-3c6e99113b29"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ON1_DIR1
		 (.oe(tmpOE__ON1_DIR1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ON1_DIR1_net[0:0]}),
		  .io({tmpIO_0__ON1_DIR1_net[0:0]}),
		  .siovref(tmpSIOVREF__ON1_DIR1_net),
		  .interrupt({tmpINTERRUPT_0__ON1_DIR1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ON1_DIR1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ON1_DIR2_net;
	wire [0:0] tmpFB_0__ON1_DIR2_net;
	wire [0:0] tmpIO_0__ON1_DIR2_net;
	wire [0:0] tmpINTERRUPT_0__ON1_DIR2_net;
	electrical [0:0] tmpSIOVREF__ON1_DIR2_net;

	cy_psoc3_pins_v1_10
		#(.id("8d499004-4dd1-4294-bb67-cdf0d7a11bcc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ON1_DIR2
		 (.oe(tmpOE__ON1_DIR2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ON1_DIR2_net[0:0]}),
		  .io({tmpIO_0__ON1_DIR2_net[0:0]}),
		  .siovref(tmpSIOVREF__ON1_DIR2_net),
		  .interrupt({tmpINTERRUPT_0__ON1_DIR2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ON1_DIR2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ON2_DIR1_net;
	wire [0:0] tmpFB_0__ON2_DIR1_net;
	wire [0:0] tmpIO_0__ON2_DIR1_net;
	wire [0:0] tmpINTERRUPT_0__ON2_DIR1_net;
	electrical [0:0] tmpSIOVREF__ON2_DIR1_net;

	cy_psoc3_pins_v1_10
		#(.id("f1115fff-2f2d-4691-83d5-b9d9d097b9bb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ON2_DIR1
		 (.oe(tmpOE__ON2_DIR1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ON2_DIR1_net[0:0]}),
		  .io({tmpIO_0__ON2_DIR1_net[0:0]}),
		  .siovref(tmpSIOVREF__ON2_DIR1_net),
		  .interrupt({tmpINTERRUPT_0__ON2_DIR1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ON2_DIR1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ON2_DIR2_net;
	wire [0:0] tmpFB_0__ON2_DIR2_net;
	wire [0:0] tmpIO_0__ON2_DIR2_net;
	wire [0:0] tmpINTERRUPT_0__ON2_DIR2_net;
	electrical [0:0] tmpSIOVREF__ON2_DIR2_net;

	cy_psoc3_pins_v1_10
		#(.id("05617f70-d5f9-4833-93ce-a633fcaa6764"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ON2_DIR2
		 (.oe(tmpOE__ON2_DIR2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ON2_DIR2_net[0:0]}),
		  .io({tmpIO_0__ON2_DIR2_net[0:0]}),
		  .siovref(tmpSIOVREF__ON2_DIR2_net),
		  .interrupt({tmpINTERRUPT_0__ON2_DIR2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ON2_DIR2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ON3_DIR1_net;
	wire [0:0] tmpFB_0__ON3_DIR1_net;
	wire [0:0] tmpIO_0__ON3_DIR1_net;
	wire [0:0] tmpINTERRUPT_0__ON3_DIR1_net;
	electrical [0:0] tmpSIOVREF__ON3_DIR1_net;

	cy_psoc3_pins_v1_10
		#(.id("639b1858-8868-4fa1-8f00-00c1c6dd258c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ON3_DIR1
		 (.oe(tmpOE__ON3_DIR1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ON3_DIR1_net[0:0]}),
		  .io({tmpIO_0__ON3_DIR1_net[0:0]}),
		  .siovref(tmpSIOVREF__ON3_DIR1_net),
		  .interrupt({tmpINTERRUPT_0__ON3_DIR1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ON3_DIR1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ON3_DIR2_net;
	wire [0:0] tmpFB_0__ON3_DIR2_net;
	wire [0:0] tmpIO_0__ON3_DIR2_net;
	wire [0:0] tmpINTERRUPT_0__ON3_DIR2_net;
	electrical [0:0] tmpSIOVREF__ON3_DIR2_net;

	cy_psoc3_pins_v1_10
		#(.id("f686d581-3bb9-4ae3-bd71-ae7c6aa1f76e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ON3_DIR2
		 (.oe(tmpOE__ON3_DIR2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ON3_DIR2_net[0:0]}),
		  .io({tmpIO_0__ON3_DIR2_net[0:0]}),
		  .siovref(tmpSIOVREF__ON3_DIR2_net),
		  .interrupt({tmpINTERRUPT_0__ON3_DIR2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ON3_DIR2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ON4_DIR1_net;
	wire [0:0] tmpFB_0__ON4_DIR1_net;
	wire [0:0] tmpIO_0__ON4_DIR1_net;
	wire [0:0] tmpINTERRUPT_0__ON4_DIR1_net;
	electrical [0:0] tmpSIOVREF__ON4_DIR1_net;

	cy_psoc3_pins_v1_10
		#(.id("9254f674-49bd-4e7d-89e1-88765952055f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ON4_DIR1
		 (.oe(tmpOE__ON4_DIR1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ON4_DIR1_net[0:0]}),
		  .io({tmpIO_0__ON4_DIR1_net[0:0]}),
		  .siovref(tmpSIOVREF__ON4_DIR1_net),
		  .interrupt({tmpINTERRUPT_0__ON4_DIR1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ON4_DIR1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ON4_DIR2_net;
	wire [0:0] tmpFB_0__ON4_DIR2_net;
	wire [0:0] tmpIO_0__ON4_DIR2_net;
	wire [0:0] tmpINTERRUPT_0__ON4_DIR2_net;
	electrical [0:0] tmpSIOVREF__ON4_DIR2_net;

	cy_psoc3_pins_v1_10
		#(.id("2065280e-e641-4b25-a608-d2c6b822322f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ON4_DIR2
		 (.oe(tmpOE__ON4_DIR2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ON4_DIR2_net[0:0]}),
		  .io({tmpIO_0__ON4_DIR2_net[0:0]}),
		  .siovref(tmpSIOVREF__ON4_DIR2_net),
		  .interrupt({tmpINTERRUPT_0__ON4_DIR2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ON4_DIR2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Ctrl_5V_net;
	wire [0:0] tmpFB_0__Ctrl_5V_net;
	wire [0:0] tmpIO_0__Ctrl_5V_net;
	wire [0:0] tmpINTERRUPT_0__Ctrl_5V_net;
	electrical [0:0] tmpSIOVREF__Ctrl_5V_net;

	cy_psoc3_pins_v1_10
		#(.id("cfc6acd8-5b27-44ab-ac5a-96ee07127bee"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Ctrl_5V
		 (.oe(tmpOE__Ctrl_5V_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ctrl_5V_net[0:0]}),
		  .io({tmpIO_0__Ctrl_5V_net[0:0]}),
		  .siovref(tmpSIOVREF__Ctrl_5V_net),
		  .interrupt({tmpINTERRUPT_0__Ctrl_5V_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ctrl_5V_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Ctrl_12V_net;
	wire [0:0] tmpFB_0__Ctrl_12V_net;
	wire [0:0] tmpIO_0__Ctrl_12V_net;
	wire [0:0] tmpINTERRUPT_0__Ctrl_12V_net;
	electrical [0:0] tmpSIOVREF__Ctrl_12V_net;

	cy_psoc3_pins_v1_10
		#(.id("d243fb65-f11d-4d2d-83fd-3fdb1ac04a80"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Ctrl_12V
		 (.oe(tmpOE__Ctrl_12V_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Ctrl_12V_net[0:0]}),
		  .io({tmpIO_0__Ctrl_12V_net[0:0]}),
		  .siovref(tmpSIOVREF__Ctrl_12V_net),
		  .interrupt({tmpINTERRUPT_0__Ctrl_12V_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ctrl_12V_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pressure1_net;
	wire [0:0] tmpFB_0__Pressure1_net;
	wire [0:0] tmpIO_0__Pressure1_net;
	wire [0:0] tmpINTERRUPT_0__Pressure1_net;
	electrical [0:0] tmpSIOVREF__Pressure1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pressure1
		 (.oe(tmpOE__Pressure1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pressure1_net[0:0]}),
		  .analog({Net_153}),
		  .io({tmpIO_0__Pressure1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pressure1_net),
		  .interrupt({tmpINTERRUPT_0__Pressure1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pressure1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pressure2_net;
	wire [0:0] tmpFB_0__Pressure2_net;
	wire [0:0] tmpIO_0__Pressure2_net;
	wire [0:0] tmpINTERRUPT_0__Pressure2_net;
	electrical [0:0] tmpSIOVREF__Pressure2_net;

	cy_psoc3_pins_v1_10
		#(.id("0178b11a-e501-4401-869d-e4604ea1aeb4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pressure2
		 (.oe(tmpOE__Pressure2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pressure2_net[0:0]}),
		  .analog({Net_154}),
		  .io({tmpIO_0__Pressure2_net[0:0]}),
		  .siovref(tmpSIOVREF__Pressure2_net),
		  .interrupt({tmpINTERRUPT_0__Pressure2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pressure2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
